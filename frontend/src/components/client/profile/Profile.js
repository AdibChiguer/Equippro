    ...
    <div className='profile-container'>
      ...
      <div className="profile-details">
        <div className="input-details">
          ...
          <input type="text" id="email" placeholder='Email' readOnly value={user ? user.email : ""}/>
        </div>
        <div className="input-details">
          <label htmlFor="firstname">First Name</label>
          <input type="text" id="firstname" placeholder='First Name' readOnly value={user ? user.prenom : ""}/>
        </div>
        <div className="input-details">
          <label htmlFor="lastname">Last Name</label>
          <input type="text" id="lastname" placeholder='Last Name' readOnly value={user ? user.nom : ""}/>
        </div>
        <div className="input-details">
          <label htmlFor="lastname">Cin :</label>
          <input type="text" id="cin" placeholder='Cin' readOnly value={user ? user.cin : ""}/>
        </div>
